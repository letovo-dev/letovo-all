...
bool delete_user_role(std::string username, std::string role, int department,
                      std::shared_ptr<cp::ConnectionsManager> pool_ptr);

int create_role(std::string role, int department, int rang, int payment,
                std::shared_ptr<cp::ConnectionsManager> pool_ptr);

pqxx::result department_roles(int department,
                              std::shared_ptr<cp::ConnectionsManager> pool_ptr);
...
void create_role(std::unique_ptr<restinio::router::express_router_t<>> &router,
                 std::shared_ptr<cp::ConnectionsManager> pool_ptr,
                 std::shared_ptr<restinio::shared_ostream_logger_t> logger_ptr);
...
void all_avatars(std::unique_ptr<restinio::router::express_router_t<>> &router,
                 std::shared_ptr<cp::ConnectionsManager> pool_ptr,
                 std::shared_ptr<restinio::shared_ostream_logger_t> logger_ptr);
